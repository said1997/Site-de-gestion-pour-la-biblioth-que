...
<header class="containe-fluide header"> 
	...
	<section class="containe-fluide banner">  
		...
		<div class="inner-banner">
			<h1>Bienvenue administrateur <?php echo $_SESSION['Nom_client']; ?>.</h1>
		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
					<div class="card">
						<div class="card-block block-6">
							...
							<p class="card-text">Cliquez en bas pour ajouter un administrateur.</p>
							<a href="inscription.php" title="Read more" class="read-more" >Ajouter<i class="fa fa-angle-double-right ml-2"></i></a>
						</div>
					</div>
				</div>
				...
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
					<div class="card">
						<div class="card-block block-1">
							<h3 class="card-title">Historique de mes clients</h3>
							<p class="card-text"> Cliquer en bas pour consulter l'historique des clients. </p>
							<a href="liste_emprunt_admin.php?id=2" title="Read more" class="read-more" >Historique.<i class="fa fa-angle-double-right ml-2"></i></a>
						</div>
					</div>
				</div>
				...
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
					<div class="card">
						<div class="card-block block-2">
							<h3 class="card-title">Clients ayant pas remis de livres</h3>
							<p class="card-text"> Cliquer en bas pour consulter tout les clients ayant pas rendu leurs livres. </p>
							<a href="liste_emprunt_admin.php?id=1" title="Read more" class="read-more" >Pas rendu.<i class="fa fa-angle-double-right ml-2"></i></a>
						</div>
					</div>
				</div>
